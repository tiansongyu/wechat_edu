...
WITH business_state AS (
  SELECT jsonb_build_object(
    ...
    'job_revisions', (SELECT COALESCE(jsonb_agg(jsonb_build_array(id, "jobId", status, version) ORDER BY id), '[]'::jsonb) FROM job_revisions),
    ...
    'conversations', (SELECT COALESCE(jsonb_agg(jsonb_build_array(id, "jobId", "applicationId", "contextKey") ORDER BY id), '[]'::jsonb) FROM conversations),
